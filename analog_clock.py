...
for h in range(0,60):
    ...
    position= [math.cos(math.radians(h*6+270))*radius_h+330,math.sin(

math.radians(h*6+270))*radius_h+330]
...
for m in range(0,60):
    ...
    position=[math.cos(math.radians(m*6+270))*radius_m+330,math.sin(

math.radians(m*6+270))*radius_m+330]
...
for s in range(0,60):
    ...
    position=[int(math.cos(math.radians(s*6+270))*radius_s+330),int(math.sin

(math.radians(s*6+270))*radius_s+330)]
...
while running:
    ...
    pygame.draw.circle(screen, (0, 0, 0), (330, 330), 330, 4)
    ...
    time_stamp=font.render(hour+":"+minute+":"+seconds+" "+get_am_or_pm(),1,
